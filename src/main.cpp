...
int main(int argc, char *argv[]) {
	...
	scene.objects.push_back(new Cylinder(Vec(0, 0, 0), Vec(0, 0, -1), 12, 30, Material(DIFF)));
	...
	scene.objects.push_back(new TubeLight(Vec(0, 0, 8), Vec(0, 0, -5), 0.5, 5, Spectrum(1.0), Material(DIFF)));
	...
	tracer->set_num_samples_per_pixel(100);
